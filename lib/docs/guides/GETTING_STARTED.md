...
全 Phase 完了時の最終形は [Library Standard](../standards/LIBRARY_STANDARD.md) を参照。
...
著作権表記規約の詳細は [Library Standard §5.5](../standards/LIBRARY_STANDARD.md) を参照。
...
Doxygen 運用の詳細は [Doxygen ガイド](DOXYGEN.md) を参照。
...
テンプレートは [Library Standard §5.1](../standards/LIBRARY_STANDARD.md) を参照。
...
スタイル詳細は [Doxygen Style](../standards/DOXYGEN_STYLE.md) を参照。
...
テンプレートは [Library Standard §4](../standards/LIBRARY_STANDARD.md) を参照。

### arm-embedded-xmake-repo パッケージ登録

テンプレートは [Library Standard §6](../standards/LIBRARY_STANDARD.md) を参照。
...
- [Library Standard](../standards/LIBRARY_STANDARD.md) — 完全仕様
- [Coding Style](../standards/CODING_STYLE.md) — コーディング規約
- [Doxygen Style](../standards/DOXYGEN_STYLE.md) — Doxygen コメント規約
- [Doxygen Guide](DOXYGEN.md) — Doxygen 運用ガイド
