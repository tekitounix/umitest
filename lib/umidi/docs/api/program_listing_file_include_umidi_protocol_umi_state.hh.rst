...
.. _program_listing_file_include_umidi_protocol_umi_state.hh:

Program Listing for File umi_state.hh
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_umi_state.hh>` (``include/umidi/protocol/umi_state.hh``)
