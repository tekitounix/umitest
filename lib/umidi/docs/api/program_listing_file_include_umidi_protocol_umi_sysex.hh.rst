...
.. _program_listing_file_include_umidi_protocol_umi_sysex.hh:

Program Listing for File umi_sysex.hh
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_umi_sysex.hh>` (``include/umidi/protocol/umi_sysex.hh``)
