...
.. _program_listing_file_include_umidi_protocol_umi_object.hh:

Program Listing for File umi_object.hh
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_umi_object.hh>` (``include/umidi/protocol/umi_object.hh``)
