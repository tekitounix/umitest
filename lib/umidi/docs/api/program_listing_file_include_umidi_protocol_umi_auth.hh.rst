...
.. _program_listing_file_include_umidi_protocol_umi_auth.hh:

Program Listing for File umi_auth.hh
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_umi_auth.hh>` (``include/umidi/protocol/umi_auth.hh``)
