...
.. _program_listing_file_include_umidi_codec_decoder.hh:

Program Listing for File decoder.hh
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_codec_decoder.hh>` (``include/umidi/codec/decoder.hh``)
