...
.. _program_listing_file_include_umidi_cc_decoder.hh:

Program Listing for File decoder.hh
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_cc_decoder.hh>` (``include/umidi/cc/decoder.hh``)
