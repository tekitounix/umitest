...
.. _program_listing_file_include_umidi_messages_channel_voice.hh:

Program Listing for File channel_voice.hh
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_messages_channel_voice.hh>` (``include/umidi/messages/channel_voice.hh``)
