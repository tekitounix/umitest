...
.. _program_listing_file_include_umidi_core_result.hh:

Program Listing for File result.hh
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_core_result.hh>` (``include/umidi/core/result.hh``)
