...
.. _program_listing_file_include_umidi_protocol_encoding.hh:

Program Listing for File encoding.hh
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_encoding.hh>` (``include/umidi/protocol/encoding.hh``)
