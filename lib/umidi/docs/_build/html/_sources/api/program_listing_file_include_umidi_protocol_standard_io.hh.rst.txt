...
.. _program_listing_file_include_umidi_protocol_standard_io.hh:

Program Listing for File standard_io.hh
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_standard_io.hh>` (``include/umidi/protocol/standard_io.hh``)
