...
.. _program_listing_file_include_umidi_cc_standards.hh:

Program Listing for File standards.hh
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_cc_standards.hh>` (``include/umidi/cc/standards.hh``)
