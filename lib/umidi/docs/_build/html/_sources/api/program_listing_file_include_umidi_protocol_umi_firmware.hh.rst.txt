...
.. _program_listing_file_include_umidi_protocol_umi_firmware.hh:

Program Listing for File umi_firmware.hh
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_umi_firmware.hh>` (``include/umidi/protocol/umi_firmware.hh``)
...
.. code-block:: cpp
   ...
   // UMI-OS Firmware Header and Signature Verification
