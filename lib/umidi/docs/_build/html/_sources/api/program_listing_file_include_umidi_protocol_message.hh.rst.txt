...
.. _program_listing_file_include_umidi_protocol_message.hh:

Program Listing for File message.hh
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_umidi_protocol_message.hh>` (``include/umidi/protocol/message.hh``)
