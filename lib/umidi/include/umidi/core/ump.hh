...
/// @file ump.hh
/// @brief UMP (Universal MIDI Packet) core types optimized for ARM Cortex-M.
#pragma once
...
/// @brief 32-bit Universal MIDI Packet (Optimized).
///
/// Stores as single uint32_t for efficient comparison and manipulation.
/// Layout: [MT:4][Group:4][Status:8][Data1:8][Data2:8]
///
/// @par Example:
/// @code
/// auto note_on = UMP32::note_on(0, 60, 100);
/// if (note_on.is_note_on()) {
///     process_note(note_on.note(), note_on.velocity());
/// }
/// @endcode
struct UMP32 {
    uint32_t word = 0;
