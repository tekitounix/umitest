...
public:
    ...
    /// @param data Raw 8-bit data to send
    ...
    /// @return Bytes received, or 0 if no data
...
/// @param out Output buffer (must be at least len + FRAME_OVERHEAD)
/// @return Frame size
...
/// @return Data length, or 0 on error
...
public:
    ...
    /// Prefers Bulk over SysEx for performance
