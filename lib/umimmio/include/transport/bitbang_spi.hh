...
class BitBangSpiTransport : public ByteAdapter<BitBangSpiTransport<Pins, CheckPolicy, ErrorPolicy, AddressType, AddrEndian, DataEndian, ReadBit, CmdMask, WriteBit>,
                                              CheckPolicy, ErrorPolicy, AddressType, DataEndian> {
    Pins& pins;
