...
int main() {
    ...
    s.run("field write with value()", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("enumerated value write and is()", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("modify single field", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("modify multiple fields", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
        mcu.write(TestDevice::Block0::REG1::value(0xFFFFFFFF));
        mcu.modify(
    ...
    s.run("Set/Reset/flip", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("register reset value", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("register and field value()", [](umitest::TestContext& t) {
        mock_memory.fill(0);
        MockDirectTransport<> mcu;
    ...
    s.run("8-bit register read/write", [](umitest::TestContext& t) {
    ...
    s.run("16-bit register (little-endian)", [](umitest::TestContext& t) {
        test::MockI2cBus i2c_bus;
        test::I2cTransport i2c_dev(i2c_bus, 0x50);
    ...
    s.run("32-bit register", [](umitest::TestContext& t) {
        test::MockI2cBus i2c_bus;
    ...
    s.run("value() range compiles", [](umitest::TestContext& t) {
