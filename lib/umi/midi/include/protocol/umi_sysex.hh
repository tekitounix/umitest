...
/// @file umi_sysex.hh
/// @brief UMI SysEx Protocol - main include file
///
/// This file aggregates all protocol components. For smaller builds,
/// include individual headers directly.
#pragma once
...
/// @brief Basic firmware update handler (without A/B partitioning).
/// @tparam MaxChunkSize Maximum chunk size for firmware data
...
/// @brief Combined handler for all UMI SysEx protocols.
...
/// @brief Secure firmware update with authentication and A/B partitioning.
