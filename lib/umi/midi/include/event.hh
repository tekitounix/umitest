...
struct Event {
    ...
    UMP32 ump;                ///< MIDI message in UMP format
...
public:
    ...
    /// Pop events up to and including sample_pos
    ...
    /// Peek at next event's sample position
...
/// Convert old-style MIDI bytes to Event
...
/// Extract MIDI bytes from Event (for serialization)
