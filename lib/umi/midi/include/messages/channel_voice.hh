...
/// @brief Type-safe MIDI 1.0 Channel Voice message wrappers.
#pragma once
...
/// @brief Note On message wrapper.
/// Zero-overhead wrapper providing semantic API over UMP32.
struct NoteOn {
    UMP32 ump;
...
/// Dispatch UMP32 to appropriate handler based on message type
/// Usage:
///   dispatch(ump, [](auto&& msg) {
///       if constexpr (std::is_same_v<std::decay_t<decltype(msg)>, NoteOn>) {
///           // handle note on
///       }
///   });
