...
|-------|------|----------------|-----------|
| 0a | port/ リファクタリング（既存STM32F4） | [01](01-principles.md), [02](02-port-architecture.md), [05](05-migration.md) | include パス全変更 |
| 0b | umimmio 移植 + concepts/ 整備 | [06](06-mmio-integration.md), [03](03-concept-contracts.md) | なし |
