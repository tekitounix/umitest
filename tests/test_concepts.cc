...
void test_processor_like_concept() {
    ...
    TEST_ASSERT((umi::ProcessorLike<SimpleProcessor>),
        "SimpleProcessor satisfies ProcessorLike");
    
    TEST_ASSERT((umi::ProcessorLike<ControllableProcessor>),
        "ControllableProcessor satisfies ProcessorLike");
...
void test_controllable_concept() {
    ...
    TEST_ASSERT((umi::Controllable<ControllableProcessor>),
        "ControllableProcessor satisfies Controllable");
    
    // SimpleProcessor does NOT satisfy Controllable (no set_param/get_param)
    TEST_ASSERT((!umi::Controllable<SimpleProcessor>),
        "SimpleProcessor does NOT satisfy Controllable");
