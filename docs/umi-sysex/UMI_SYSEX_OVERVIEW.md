...
| UMI_SYSEX_STATUS.md | UMI-STATUS 仕様（予定） |
| UMI_SYSEX_STATUS_IMPLEMENTATION_NOTES.md | UMI-STATUS 実装ノート |
| UMI_SYSEX_DATA.md | UMI-DATA 概要（予定） |
| UMI_SYSEX_DATA_SPEC.md | UMI-DATA 詳細仕様（移植予定） |
